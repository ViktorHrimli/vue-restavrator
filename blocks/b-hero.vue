		...
		<div class="c-body">
			<section class="c-content-section">
				<div class="c-content-wp">
					<ui-title class="the-title the-title-title" ref="titleAnimationRef" v-bind="theTitle" :content="title" v-if="title" />
					<div class="c-label-wp">
						<ui-title class="the-title the-label" ref="labelAnimationRef" v-bind="theTitle" :content="label" tag="div" v-if="label" />
						<adaptive-image
							class="the-scratch"
							src="/images/scratch-hero.jpg"
							alt="hero scratch"
							sizes="mobile:150px tablet:300px"
			...
			<section class="c-media-section">
				...
				<smart-media id="mediaEl"  class="the-media-wp" v-bind="theMedia" @click.once="useTrackEvent('playVideo', {placement:'hero',title:'promo'})"/>
			</section>
		</div>
	</root-section>
</template>
