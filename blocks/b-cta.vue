<template>
	<root-section v-bind="wp">
		<div class="c-card" ref="containerRef">
			<smart-media sizes="mobile:150px tablet:450px" class="c-scratch left" src="/images/scratch-cta-left.png"
				alt="scratch" />
			<smart-media sizes="mobile:150px tablet:450px" class="c-scratch right" src="/images/scratch-cta-right.png"
				alt="scratch" />
			<div class="c-section">
