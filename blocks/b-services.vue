<template>
	<root-section>
		<ui-title tag="h2" class="fw-900 text-uppercase the-label" ref="animatedLabelRef" v-bind="theContent" v-if="content"/>
			...
			<section class="services-section" ref="servicesSectionRef">
				...
				<ul class="c-services-container">
					<li class="c-single-service" v-for="(service, si) in list" :key="si" ref="servicesRefs">
						<inline-svg v-if="service?.icon" class="ss-number" width="34px" height="34px" :src='iconSrc(service.icon)' />
				...
				<img class="c-scratch" src="/images/scratch-services.jpg" alt="scratch">
			</section>
