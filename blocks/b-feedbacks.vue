	...
	<root-section>
		<div class="c-container" ref="containerAnimationRef">
			<div class="section-media">
				<smart-media class="the-media" v-bind="theMedia"
					@click.once="useTrackEvent('playVideo', { placement: 'feedbacks', title: 'feedbacksMix' })" />
			</div>
			<div class="section-content">
				<div class="c-count fs-adaptive-xxl fw-900 "><span ref="counterRef" v-html="count"></span>+</div>
				<ui-paragraph class="c-content fs-adaptive-xl fw-900 text-uppercase" ref="contentAnimationRef"
					v-bind="theContent" />
